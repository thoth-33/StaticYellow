...
FuchsiaGym_TextPointers:
	...
	dw_const FuchsiaGymRocker7Text,           TEXT_FUCHSIAGYM_ROCKER7
...
FuchsiaGymTrainerHeader6:
	trainer EVENT_BEAT_FUCHSIA_GYM_TRAINER_6, 2, FuchsiaGymRocker7BattleText, FuchsiaGymRocker7EndBattleText, FuchsiaGymRocker7AfterBattleText	
	db -1 ; end
...
FuchsiaGymRocker7Text:
	text_asm
	ld hl, FuchsiaGymTrainerHeader6
	call TalkToTrainer
	rst TextScriptEnd

FuchsiaGymRocker7BattleText:
	text_far _FuchsiaGymRocker7BattleText
	text_end

FuchsiaGymRocker7EndBattleText:
	text_far _FuchsiaGymRocker7EndBattleText
	text_end

FuchsiaGymRocker7AfterBattleText:
	text_far _FuchsiaGymRocker7AfterBattleText
	text_end
