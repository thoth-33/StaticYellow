...
; TODO: mark sprite constants with an X that are never used
	...
	const HS_VIRIDIAN_GYM_JESSIE
	const HS_VIRIDIAN_GYM_JAMES
	...
	const HS_INDIGO_PLATEU_LOBBY_CLERK_HS  ; E4
	...
	const HS_POKEMON_MANSION_B1F_JAMES     ; C3A
	const HS_POKEMON_MANSION_B1F_JESSIE    ; C4B
