...
; Lavender Town events
	...
	const_skip
	const EVENT_BEAT_POKEMONTOWER_8_TRAINER_0
	const EVENT_BEAT_POKEMONTOWER_8_TRAINER_1
	const EVENT_BEAT_POKEMONTOWER_8_TRAINER_2
	const_skip 12
...
; Rocket Hideout events
	...
	const EVENT_BEAT_ROCKET_HIDEOUT_3_TRAINER_3
	const_skip 11
	const EVENT_6A0
	const_skip
