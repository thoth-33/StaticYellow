...
;INCLUDE "engine/events/hidden_objects/indigo_plateau_statues.asm" ; Removed due to being unaccesible
...
;INCLUDE "engine/overworld/unused_load_missable_object_data.asm" ; Removed from game
...
;INCLUDE "engine/menus/unused_input.asm" ; Removed from game
