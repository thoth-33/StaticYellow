...
; Rematch
	db $FF, 80, CLEFABLE, 80, MUK, 80, SLOWBRO, 80, HITMONLEE, 80, RHYDON, 80, MACHAMP, 0
...
; Rematch
	db $FF, 85, ALAKAZAM, 85, MACHAMP, 85, GYARADOS, 85, PIDGEOT, 85, EXEGGUTOR, 85, ARCANINE, 0

LoreleiData:
	db $FF, 54, DEWGONG, 54, STARMIE, 55, CLOYSTER, 55, SLOWBRO, 56, JYNX, 56, LAPRAS, 0
; Rematch
	db $FF, 80, WIGGLYTUFF, 80, STARMIE, 80, CLOYSTER, 80, OMASTAR, 80, EXEGGUTOR, 80, LAPRAS, 0
...
; Rematch
	db $FF, 80, JYNX, 80, GYARADOS, 80, ALAKAZAM, 80, VENUSAUR, 80, ARBOK, 80, GENGAR, 0

LanceData:
	db $FF, 60, GYARADOS, 60, CHARIZARD, 60, SEADRA, 60, ELECTABUZZ, 61, AERODACTYL, 62, DRAGONITE, 0
; Rematch
	db $FF, 80, ARCANINE, 80, ELECTABUZZ, 80, SNORLAX, 80, CHARIZARD, 80, KANGASKHAN, 80, DRAGONITE, 0
