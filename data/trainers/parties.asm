...
BrockData:
	db $FF, 13, GEODUDE, 14, ZUBAT, 15, ONIX, 0

MistyData:
	db $FF, 19, PSYDUCK, 19, STARYU, 22, STARMIE, 0
...
KogaData:
	db $FF, 43, GOLBAT, 43, MUK, 43, WEEZING, 44, VENOMOTH, 0

BlaineData:
	db $FF, 47, FLAREON, 47, NINETALES, 47, RAPIDASH, 48, ARCANINE, 48, MAGMAR, 0

SabrinaData:
	db $FF, 45, SLOWBRO, 45, MR_MIME, 45, JYNX, 45, HYPNO, 46, ALAKAZAM, 0
...
; Route 22
	db $FF, 47, SANDSLASH, 47, EXEGGCUTE, 47, NINETALES, 47, CLOYSTER, 50, ALAKAZAM, 53, JOLTEON, 0
	db $FF, 47, SANDSLASH, 47, EXEGGCUTE, 47, CLOYSTER, 47, MAGNETON, 50, ALAKAZAM, 53, FLAREON, 0
	db $FF, 47, SANDSLASH, 47, EXEGGCUTE, 47, MAGNETON, 47, NINETALES, 50, ALAKAZAM, 53, VAPOREON, 0
