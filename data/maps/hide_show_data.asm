...
BluesHouse1FHS:
	db BLUES_HOUSE_1F, BLUESHOUSE1F_DAISY1,   SHOW
	db BLUES_HOUSE_1F, BLUESHOUSE1F_DAISY2,   HIDE
	db BLUES_HOUSE_1F, BLUESHOUSE1F_TOWN_MAP, SHOW
OaksLabHS:
...
ViridianGymHS:
	...
	db VIRIDIAN_GYM, VIRIDIANGYM_JESSIE,   SHOW
	db VIRIDIAN_GYM, VIRIDIANGYM_JAMES,    SHOW
...
PokemonTower8FHS:
	db POKEMON_TOWER_8F, POKEMONTOWER8F_ROCKET1, SHOW
	db POKEMON_TOWER_8F, POKEMONTOWER8F_ROCKET2, SHOW
	db POKEMON_TOWER_8F, POKEMONTOWER8F_ROCKET3, SHOW
PokemonMansion2FHS:
...
PokemonMansionB1FHS:
	db POKEMON_MANSION_B1F, POKEMONMANSIONB1F_JAMES,        HIDE
	db POKEMON_MANSION_B1F, POKEMONMANSIONB1F_JESSIE,       HIDE
...
CeruleanCaveB1FHS:
	...
	db CERULEAN_CAVE_B1F, CERULEANCAVEB1F_MEW,         SHOW
VictoryRoad1FHS:
...
ChampionsRoomHS:
	...
	db CHAMPIONS_ROOM, CHAMPIONSROOM_JOLTEON, HIDE
	db CHAMPIONS_ROOM, CHAMPIONSROOM_FLAREON, HIDE
	db CHAMPIONS_ROOM, CHAMPIONSROOM_VAPOREON, HIDE
SeafoamIslands1FHS:
