MapSongBanks::
	...
	db MUSIC_PALLET_TOWN, BANK(Music_PalletTown) ; BLUES_HOUSE_1F
	...
	db MUSIC_PALLET_TOWN, BANK(Music_PalletTown) ; BLUES_HOUSE_2F
	db MUSIC_POKEMON_TOWER, BANK(Music_PokemonTower) ; POKEMON_TOWER_8F
