	object_const_def
	const_export POKEMONMANSIONB1F_JAMES
	const_export POKEMONMANSIONB1F_JESSIE
...
PokemonMansionB1F_Object:
	...
	def_object_events
	object_event 27, 12, SPRITE_JAMES, STAY, DOWN, TEXT_POKEMONMANSIONB1F_JAMES
	object_event 26, 12, SPRITE_JESSIE, STAY, DOWN, TEXT_POKEMONMANSIONB1F_JESSIE
	object_event 16, 23, SPRITE_SUPER_NERD, STAY, DOWN, TEXT_POKEMONMANSIONB1F_BURGLAR, OPP_BURGLAR, 9
	object_event  8,  5, SPRITE_SCIENTIST, STAY, DOWN, TEXT_POKEMONMANSIONB1F_SCIENTIST, OPP_SCIENTIST, 13
