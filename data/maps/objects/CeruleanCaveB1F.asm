	...
	const_export CERULEANCAVEB1F_MEW
...
CeruleanCaveB1F_Object:
	...
	object_event 25, 14, SPRITE_POKE_BALL, STAY, NONE, TEXT_CERULEANCAVEB1F_ULTRA_BALL2, ULTRA_BALL
	object_event  1, 14, SPRITE_POKE_BALL, STAY, NONE, TEXT_CERULEANCAVEB1F_MAX_REVIVE, MAX_REVIVE
	object_event 15,  3, SPRITE_POKE_BALL, STAY, NONE, TEXT_CERULEANCAVEB1F_MAX_ELIXER, MAX_ELIXER
	object_event  3, 13, SPRITE_MONSTER, STAY, DOWN, TEXT_CERULEANCAVEB1F_MEW, MEW, 70
