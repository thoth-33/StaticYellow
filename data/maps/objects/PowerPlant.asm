...
PowerPlant_Object:
	...
	object_event 25, 18, SPRITE_ELECTRODE, STAY, NONE, TEXT_POWERPLANT_ELECTRODE1, ELECTRODE, 43
	...
	object_event 21, 14, SPRITE_ELECTRODE, STAY, NONE, TEXT_POWERPLANT_ELECTRODE2, ELECTRODE, 43
