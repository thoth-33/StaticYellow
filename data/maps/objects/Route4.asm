...
Route4_Object:
	...
	object_event 65,  3, SPRITE_COOLTRAINER_F, STAY, RIGHT, TEXT_ROUTE4_COOLTRAINER_F2, OPP_LASS, 4
	object_event 65,  4, SPRITE_COOLTRAINER_M, STAY, LEFT, TEXT_ROUTE4_YOUNGSTER, OPP_YOUNGSTER, 13
