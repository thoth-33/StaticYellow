	...
	const_export VIRIDIANGYM_JESSIE
...
ViridianGym_Object:
	...
	object_event  5,  4, SPRITE_JESSIE, STAY, RIGHT, TEXT_VIRIDIANGYM_JESSIE
	object_event  5,  3, SPRITE_JAMES, STAY, RIGHT, TEXT_VIRIDIANGYM_JAMES
