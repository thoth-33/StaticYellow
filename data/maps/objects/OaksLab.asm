...
OaksLab_Object:
	...
	object_event  7,  3, SPRITE_POKE_BALL2, STAY, NONE, TEXT_OAKSLAB_EEVEE_POKE_BALL
	object_event  5,  2, SPRITE_OAK, STAY, DOWN, TEXT_OAKSLAB_OAK1
	object_event  2,  1, SPRITE_POKEDEX1, STAY, NONE, TEXT_OAKSLAB_POKEDEX1
	object_event  3,  1, SPRITE_POKEDEX1, STAY, NONE, TEXT_OAKSLAB_POKEDEX2
