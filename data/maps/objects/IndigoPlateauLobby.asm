	...
	const_export INDIGOPLATEAULOBBY_POST_GAME_CLERK
...
IndigoPlateauLobby_Object:
	...
	object_event  4, 10, SPRITE_GYM_GUIDE, STAY, RIGHT, TEXT_INDIGOPLATEAULOBBY_GYM_GUIDE
	object_event  4,  1, SPRITE_COOLTRAINER_F, STAY, DOWN, TEXT_INDIGOPLATEAULOBBY_COOLTRAINER_F
	...
	object_event  0,  7, SPRITE_KRIS,    STAY, RIGHT, TEXT_INDIGOPLATEAULOBBY_POST_GAME_CLERK
